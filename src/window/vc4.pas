...
uses 
  {$ifdef ultibo}GlobalConfig,GlobalConst,GlobalTypes,Platform,Threads,HeapManager,Syscalls,Devices,VC4V3D,VC4VCHIQ,{VC4VCSM,}Audio,Video,{$endif}
  CTypes,SysUtils; //To Do //Add VCSM when completed
...
type
 ...
 DISPLAY_INFO_T = record
  ...
  width : UInt32;                      {Width / Height}
  height : UInt32;
  input_format : DISPLAY_INPUT_FORMAT_T; {Output format}
  interlaced : UInt32;                 {Interlaced?}
  output_dither : DISPLAY_DITHER_T;      {Output dither setting (if required)}
  pixel_freq : UInt32;                 {Pixel frequency}
  line_rate : UInt32;                  {Line rate in lines per second}
  format_3d : DISPLAY_3D_FORMAT_T;       {Format required for image data for 3D displays}
  use_pixelvalve_1 : UInt32;           {If display requires PV1 (e.g. DSI1), special config is required in HVS}
  dsi_video_mode : UInt32;             {Set for DSI displays which use video mode}
  hvs_channel : UInt32;                {Select HVS channel (usually 0)}
 end;
...
type
 ...
 VC_IMAGE_T = record
  ...
  mem_handle : UInt32;                   {The mem handle for relocatable memory storage}
  ...
  video_timestamp : UInt32;              {90000 Hz RTP times domain - derived from audio timestamp}
  num_channels : UInt8;                  {Number of channels (2 for stereo)}
  current_channel : UInt8;               {The channel this header is currently pointing to}
  linked_multichann_flag : UInt8;        {Indicate the header has the linked-multichannel structure}
  is_channel_linked : UInt8;             {Track if the above structure is been used to link the header into a linked-mulitchannel image}
  channel_index : UInt8;                 {Index of the channel this header represents while it is being linked}
  _dummy : array[0..2] of UInt8;         {Pad struct to 64 bytes}
 end;
...
type
 ...
 DISPMANX_ELEMENT_HANDLE_T = UInt32;
...
function VCVCHIFilesysInit(instance: PVCHI_INSTANCE_T; connections: PPVCHI_CONNECTION_T; num_connections: UInt32): Integer; cdecl; external libvchostif name 'vc_vchi_filesys_init';
...
function VCHIInitialise(instance: PPVCHI_INSTANCE_T): Int32; cdecl; external libvchiq_arm name 'vchi_initialise'; 
function VCHIConnect(connections: PPVCHI_CONNECTION_T; num_connections: UInt32; instance: PVCHI_INSTANCE_T): Int32; cdecl; external libvchiq_arm name 'vchi_connect'; 
...
//To Do
//void vcsm_status( VCSM_STATUS_T status, Integer pid );
//unsigned Integer vcsm_malloc( unsigned Integer size, char *name );
//unsigned Integer vcsm_malloc_cache( unsigned Integer size, VCSM_CACHE_TYPE_T cache, char *name );
//unsigned Integer vcsm_malloc_share( unsigned Integer handle );
//Integer vcsm_resize( unsigned Integer handle, unsigned Integer new_size );
//void vcsm_free( unsigned Integer handle );
//unsigned Integer vcsm_vc_hdl_from_ptr( void *usr_ptr );
//unsigned Integer vcsm_vc_hdl_from_hdl( unsigned Integer handle );
//unsigned Integer vcsm_usr_handle( void *usr_ptr );
//void *vcsm_usr_address( unsigned Integer handle );
//void *vcsm_lock( unsigned Integer handle );
//void *vcsm_lock_cache( unsigned Integer handle, VCSM_CACHE_TYPE_T cache_update, VCSM_CACHE_TYPE_T *cache_result );
//Integer vcsm_unlock_ptr( void *usr_ptr );
//Integer vcsm_unlock_ptr_sp( void *usr_ptr, Integer cache_no_flush );
//Integer vcsm_unlock_hdl( unsigned Integer handle );
//Integer vcsm_unlock_hdl_sp( unsigned Integer handle, Integer cache_no_flush );
...
function vc4_mbox_open: Integer; cdecl; public name 'vc4_mbox_open';
procedure vc4_mbox_close(file_desc: Integer); cdecl; public name 'vc4_mbox_close';

function vc4_mem_alloc(file_desc: Integer; size, align, flags: cunsigned): cunsigned; cdecl; public name 'vc4_mem_alloc';
function vc4_mem_free(file_desc: Integer; handle: cunsigned): cunsigned; cdecl; public name 'vc4_mem_free';
function vc4_mem_lock(file_desc: Integer; handle: cunsigned): cunsigned; cdecl; public name 'vc4_mem_lock';
function vc4_mem_unlock(file_desc: Integer; handle: cunsigned): cunsigned; cdecl; public name 'vc4_mem_unlock';
...
function vc4_execute_code(file_desc: Integer; code, r0, r1, r2, r3, r4, r5: cunsigned): cunsigned; cdecl; public name 'vc4_execute_code';
function vc4_execute_qpu(file_desc: Integer; num_qpus, control, noflush, timeout: cunsigned): cunsigned; cdecl; public name 'vc4_execute_qpu';
function vc4_qpu_enable(file_desc: Integer; enable: cunsigned): cunsigned; cdecl; public name 'vc4_qpu_enable';
...
function vc4_vcos_get_ticks_per_second: UInt32; cdecl; public name 'vc4_vcos_get_ticks_per_second';
...
function vc4_vchiq_open: Integer; cdecl; public name 'vc4_vchiq_open';
function vc4_vchiq_dup(device: Integer): Integer; cdecl; public name 'vc4_vchiq_dup';
function vc4_vchiq_close(device: Integer): Integer; cdecl; public name 'vc4_vchiq_close';

function vc4_vchiq_ioctl(device, ioctl_code, argument: Integer): Integer; cdecl; public name 'vc4_vchiq_ioctl';

{==============================================================================}
{VC4 VCSM Helper Functions}
function vc4_vcsm_open: Integer; cdecl; public name 'vc4_vcsm_open';
function vc4_vcsm_close(device: Integer): Integer; cdecl; public name 'vc4_vcsm_close';

function vc4_vcsm_ioctl(device, ioctl_code, argument: Integer): Integer; cdecl; public name 'vc4_vcsm_ioctl';
...
{==============================================================================}
{VC4 Helper Functions}
function vc4_mbox_open: Integer; cdecl;
...
procedure vc4_mbox_close(file_desc: Integer); cdecl;
...
function vc4_mem_alloc(file_desc: Integer; size, align, flags: cunsigned): cunsigned; cdecl;
{Allocate memory from the VC4 GPU}
...
function vc4_mem_free(file_desc: Integer; handle: cunsigned): cunsigned; cdecl;
{Release memory allocated from the VC4 GPU}
...
function vc4_mem_lock(file_desc: Integer; handle: cunsigned): cunsigned; cdecl;
{Lock memory allocated from the VC4 GPU and return an address}
...
function vc4_mem_unlock(file_desc: Integer; handle: cunsigned): cunsigned; cdecl;
{Unlock memory allocated from the VC4 GPU}
...
function vc4_execute_code(file_desc: Integer; code, r0, r1, r2, r3, r4, r5: cunsigned): cunsigned; cdecl;
{Execute a block of code on the VC4 GPU}
...
function vc4_execute_qpu(file_desc: Integer; num_qpus, control, noflush, timeout: cunsigned): cunsigned; cdecl;
{Execute QPU code using the Mailbox property tags channel}
...
function vc4_qpu_enable(file_desc: Integer; enable: cunsigned): cunsigned; cdecl;
{Enable QPUs using the Mailbox property tags channel}
...
{==============================================================================}
{VC4 VCOS Helper Functions}
function vc4_vcos_get_ticks_per_second: UInt32; cdecl;
...
{==============================================================================}
{VC4 VCHIQ_ARM Helper Functions}
function vc4_vchiq_open: Integer; cdecl;
...
function vc4_vchiq_dup(device: Integer): Integer; cdecl;
...
function vc4_vchiq_close(device: Integer): Integer; cdecl;
...
function vc4_vchiq_ioctl(device, ioctl_code, argument: Integer): Integer; cdecl;
...
{==============================================================================}
{VC4 VCSM Helper Functions}
function vc4_vcsm_open: Integer; cdecl;
...
function vc4_vcsm_close(device: Integer): Integer; cdecl;
...
function vc4_vcsm_ioctl(device, ioctl_code, argument: Integer): Integer; cdecl;
